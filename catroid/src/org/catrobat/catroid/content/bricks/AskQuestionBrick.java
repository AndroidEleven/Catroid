...
public class AskQuestionBrick extends UserVariableBrick {
...
//	private transient String defaultPrototypeToken = null;
	...
	public AskQuestionBrick(String question) {
		this.question = new Formula(question);
		initializeBrickFields(this.question);
	}

	public AskQuestionBrick(Formula question, UserVariable userVariable) {
		initializeBrickFields(question);
		this.userVariable = userVariable;
	}

	private void initializeBrickFields(Formula question) {
		addAllowedBrickField(BrickField.ASK);
		setFormulaWithBrickField(BrickField.ASK, question);
	}
...
//	}
	...
	public List<SequenceAction> addActionToSequence(Sprite sprite, SequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory().createAskQuestionAction(sprite, this.question, userVariable));
		return null;
	}
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, R.layout.brick_ask_question, null);
		view = getViewWithAlpha(alphaValue);
		setCheckboxView(R.id.brick_ask_question_checkbox);
		...
		getFormulaWithBrickField(BrickField.ASK).setTextFieldId(R.id.brick_ask_question_edit_text);
		getFormulaWithBrickField(BrickField.ASK).refreshTextField(view);
		textField.setVisibility(View.VISIBLE);
		textField.setOnClickListener(this);

		Spinner variableSpinner = (Spinner) view.findViewById(R.id.brick_ask_question_spinner);
		...
		variableSpinner.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View view, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_UP
					...
					dialog.addVariableDialogListener(AskQuestionBrick.this);
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, R.layout.brick_ask_question, null);
		Spinner variableSpinner = (Spinner) prototypeView.findViewById(R.id.brick_ask_question_spinner);
		UserBrick currentBrick = ProjectManager.getInstance().getCurrentUserBrick();
		...
		textSetVariable.setText(context.getString(R.string.brick_ask_question_default_value));
...
//		}
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			TextView textSetVariable = (TextView) view.findViewById(R.id.brick_ask_question_label);
			TextView textTo = (TextView) view.findViewById(R.id.brick_ask_question_store_answer_label);
			TextView editVariable = (TextView) view.findViewById(R.id.brick_ask_question_edit_text);
			Spinner variablebrickSpinner = (Spinner) view.findViewById(R.id.brick_ask_question_spinner);
	...
	@Override
	public AskQuestionBrick copyBrickForSprite(Sprite sprite) {
		Project currentProject = ProjectManager.getInstance().getCurrentProject();
		AskQuestionBrick copyBrick = clone();
	...
	@Override
	public AskQuestionBrick clone() {
		AskQuestionBrick clonedBrick = new AskQuestionBrick(getFormulaWithBrickField(BrickField.ASK)
				.clone(), userVariable);
